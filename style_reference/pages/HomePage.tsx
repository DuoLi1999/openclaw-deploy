      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-orange-600 font-semibold">待处理</span>
          </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-purple-600 font-semibold">效率</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-gray-800">最近文案</h3>
              <Link to="/content" className="text-sm text-blue-700 hover:text-blue-800">
                查看全部 →
              </Link>
            </div>
          </div>
          <div className="divide-y divide-gray-200">
            {recentContents.map((content) => (
              <div key={content.id} className="p-6 hover:bg-gray-50 transition cursor-pointer">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <h3 className="font-bold text-gray-800">待办事项</h3>
            </div>
            <div className="p-6 space-y-3">
              {todos.map((todo) => (
                <div key={todo.id} className="flex items-start gap-3">
                  <input type="checkbox" className="mt-1 w-4 h-4 text-blue-700 rounded" />
                  <div className="flex-1">
